...
export interface ApiCertificationCertification extends Struct.SingleTypeSchema {
  collectionName: 'certifications';
  info: {
    displayName: 'Certifica\u00E7\u00E3o';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.Enumeration<
      ['emerald', 'sky', 'rose', 'cyan', 'indigo', 'amber', 'violet']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiCoursesSectionCoursesSection
  extends Struct.SingleTypeSchema {
  collectionName: 'courses_sections';
  info: {
    displayName: 'Se\u00E7\u00E3o Cursos';
    pluralName: 'courses-sections';
    singularName: 'courses-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::courses-section.courses-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slides: Schema.Attribute.Component<'slides.hero-slide', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavBarNavBar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dark_logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::nav-bar.nav-bar'
    >;
    nav_button: Schema.Attribute.Component<'buttons.navigation-button', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    nav_link: Schema.Attribute.Component<'links.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    white_logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPublicationsSectionPublicationsSection
  extends Struct.SingleTypeSchema {
  collectionName: 'publications_sections';
  info: {
    displayName: 'Se\u00E7\u00E3o Publica\u00E7\u00F5es';
    pluralName: 'publications-sections';
    singularName: 'publications-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::publications-section.publications-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::publications-section.publications-section': ApiPublicationsSectionPublicationsSection;
